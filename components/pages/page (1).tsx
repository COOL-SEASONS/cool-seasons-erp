...
import { LayoutDashboard, Users, FolderOpen, Wrench, DollarSign, Package, UserCheck, FileText, Bell, ChevronDown, AlertCircle, AlertTriangle, TrendingUp, Building2, Settings, Menu, X, BarChart3, Car, FileCheck, ClipboardList, Phone, Calendar, Award } from 'lucide-react'
  ...
  return (
    <div>
      <div className="page-header">
        ...
        {totalAlerts>0 && <div style={{background:'#FDECEA',border:'1px solid #C0392B30',borderRadius:8,padding:'8px 14px',display:'flex',alignItems:'center',gap:8}}><AlertTriangle size={16} color="#C0392B"/><span style={{fontSize:13,fontWeight:700,color:'#C0392B'}}>{totalAlerts} تنبيه يحتاج انتباهك</span></div>}
      </div>
