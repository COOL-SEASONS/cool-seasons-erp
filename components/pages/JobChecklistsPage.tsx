...
const DEFAULT_ITEMS = [
  ...
  'فحص اللوحة الكهربائية (Control Board)',
  'فحص صمام التمدد (Expansion Valve)',
  'فحص عزل الأنابيب (Pipe Insulation)',
  // === أعمال الدكت والجريلات (Ducting & Grilles) ===
  'فحص الدكت — التوصيلات (Duct Connections)',
  'فحص الدكت — العزل الحراري (Duct Insulation)',
  'فحص الدكت — التسريبات (Duct Leakage)',
  'فحص الدكت — الفلانشات (Duct Flanges)',
  'فحص الجريلات — التركيب (Grilles Installation)',
  'فحص الجريلات — التنظيف (Grilles Cleaning)',
  'فحص الديفيوزرات (Diffusers)',
  'فحص الدامبرات (Dampers)',
  'فحص فتحات الإمداد (Supply Air Outlets)',
  'فحص فتحات العودة (Return Air Outlets)',
  'فحص العزل الحراري للأسقف (Ceiling Insulation)',
  'فحص الـ VAV Boxes',
  'فحص حساسات الحرارة (Temperature Sensors)',
